...
@section('title', __('Otc Sale Payment Details'))

@section('breadcrumb')
    <li><a href="/admin/sale/otcsale/list"><i class=""></i>{{__('Otc Sale List')}}</a></li>
@endsection
@section('css')
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body">
                  <div class="row">
                        <div class="col-md-4">
                            <label>{{__('hirise.totalamt')}} : {{$otcsale['total_amount']}}</label>
                        </div>
                    </div><br>
