...
@section('breadcrumb')
    <li><a href="/admin/sale/list"><i class=""></i> {{__('Update Order')}} </a></li>
...
@section('main_section')
    <section class="content">
            ...
            <div class="box box-primary">
                ...
                <form id="unload-data-validation" action="/admin/sale/update/order/{{$saleData->id}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="store_name" value="{{$saleData->store_name}}" class="input-css" readonly="">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="battery_no" value="@if(isset($orderData['battery_number'])){{$orderData['battery_number']}}@endif" class="input-css" >
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="tyre_make" id="tyre_make" class="input-css select2">
                                ...
                                @foreach($tyre as $key => $val)
                                    <option value="{{$val->key}}" {{((old($orderData['tyre_make']) == $val->key) ? 'selected' : (($orderData['tyre_make'] == $val->key)? 'selected' : '') )}} >{{$val->value}}</option>
                                @endforeach
                            </select>
