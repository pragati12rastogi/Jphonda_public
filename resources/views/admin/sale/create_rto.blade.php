...
@section('title', __('hirise.create_rto'))

@section('breadcrumb')
    <li><a href="#"><i class=""></i> {{__('hirise.create_rto')}} </a></li>
            ...
            <div class="box box-primary">
                ...
                <form id="unload-data-validation" action="/admin/sale/rto" method="post">
                    ...
                    <div class="row">
                        ...
                        @if($bookingData->finance_status == 1)
                        <div class="col-md-4">
                            <label>Note :- <small style="color:red">Financer Changed.</small></label>
                        </div>
                        @endif
                    </div><br>
                    <div class="row">
                        ...
                        @if(in_array($bookingData->customer_pay_type,['finance','self_finance']))
                        <div class="col-md-6">
