...
@section('title', __('Reporting Manager Attendance List'))

@section('breadcrumb')
    <li><a href="#"><i class=""></i>Reporting Manager Attendance List</a></li>
@endsection
@section('css')
      ...
      dataTable.destroy();
       ...
       dataTable = $('#admin_table').DataTable({
         ...
         'createdRow':function(row,data,dataIndex)
          ...
          "rowId":"id",
          "ajax": {
            "url": "/admin/hr/user/reported/attendance/list/api",
            "datatype": "json",
                "data": function (data) {
...
$(document).on('click','#nopbutton',function(){
     ...
     var comment=$("#comment").val();
      ...
      {
        $.ajax({
            url:'/admin/hr/user/reporting/attendance/nop',
...
$("#anchor").click(function(){
  ...
  function geturl(){
        ...
        var year = $('#year').val();
        var date = $("#date").val();
        var emp_id = $("#store_name").val();
        $("#anchor").attr("href", '/admin/export/data/report/attendance?month='+month+'&year='+year+'&date='+date+'&emp_id='+emp_id);
...
<!--                    <h3 class="box-title">{{__('customer.mytitle')}} </h3>-->
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                    <div class="col-md-6"><a href="/admin/export/data/report/attendance" id="anchor" class="btn btn-info">Export</a></div>
