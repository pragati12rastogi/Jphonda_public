            ...
            $(".serviceappended-div").append(
                '<div class=" row service-condition-row servicecharge appended-content">'+
                    '<div class="col-md-2">'+
                        ...
                        '<option value="job_card_type">Job Card Type</option>'+
                        '<option value="value_added_services">Value Added Services</option>'+
                        '</select>'+ 
...
@section('main_section')
    <section class="content">
            ...
            <form id="my-form1" action="/admin/incentive/program/service" method="POST">
                @csrf
            <input type="text" name="cat_type" value="service" class="cat_type" style="opacity:0">
            ...
            <div class="box box-primary">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <label>Total Service Done Quantity<sup>*</sup></label>
