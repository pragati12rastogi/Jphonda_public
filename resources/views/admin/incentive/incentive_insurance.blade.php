            ...
            $(".serviceappended-div").append(
                '<div class=" row service-condition-row servicecharge appended-content">'+
                    '<div class="col-md-2">'+
                        ...
                        '<option value="no_of_insurance_renewal">Number Of Insurance Renewal</option>'+
...
@section('main_section')
    <section class="content">
            ...
            <form id="my-form1" action="/admin/incentive/program/insurance" method="POST">
                @csrf
            <input type="text" name="cat_type" value="insurance" class="cat_type" style="opacity:0">
            ...
            <div class="box box-primary">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <label>Total Insurance Renewal Quantity<sup>*</sup></label>
