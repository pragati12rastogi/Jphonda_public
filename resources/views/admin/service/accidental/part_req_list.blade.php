@extends($layout)
@section('title', __('Part Requested List'))
@section('breadcrumb')
...
<script>
   ...
   $(document).ready(function() {
     dataTable = $('#table').DataTable({
         "processing": true,
         "serverSide": true,
         "ajax": "/admin/accidental/part/request/list/api",
         "aaSorting": [],
         "responsive": true,
         "columns": [
             { "data": "tag"},
             ...
             { "data": "job_card_type"},
             {
                 ...
                 {
                    var str = '';
                     str = str+'<a href="/admin/accidental/assign/part/'+data+'" class="assign_bay"><button class="btn btn-primary btn-xs ">Part Assign</button></a> ';
                     return str;
                 },
                 "orderable": false
             }
