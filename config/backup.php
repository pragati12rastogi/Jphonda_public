...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'jphonda-backup'),
        ...
        'source' => [
            ...
            'files' => [
                ...
                'exclude' => [
                    ...
                    base_path('public/images/adminprofile'),
                    base_path('storage')
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'pushpendra@dkinfosolution.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'pushpendra@dkinfosolution.com'),
                'name' => env('MAIL_FROM_NAME', 'Jphonda'),
            ],
        ],
